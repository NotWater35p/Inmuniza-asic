...
Route::middleware(['auth', 'no.cache'])->group(function () {
    ...
    // ── DASHBOARD ─────────────────────────────────────────────────
    // Accesible por todos los niveles — el controlador decide qué vista mostrar
    ...
    // ── SOLO ADMIN Y ASISTENTE (nivel 3 y 5) ──────────────────────
    Route::middleware('nivel.acceso:3,5')->group(function () {
        ...
        Route::get('vacunas/{id}/pdf', [VacunaController::class, 'generarPDF'])->name('vacunas.pdf');
    ...
    // ── TODOS LOS NIVELES AUTENTICADOS ────────────────────────────
    // (admin, asistente y jefe de módulo)
    ...
    // Etnias y sectores (modales AJAX)
    ...
    Route::get('pacientes/{paciente}/historial', [TratamientoController::class, 'historialPaciente'])
    ->name('tratamientos.historial.paciente');

    // AJAX buscar paciente
    ...
    // Reportes del módulo — accesible por jefe y admin
