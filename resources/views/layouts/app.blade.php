                    ...
                    <ul class="p-2 text-sm text-body font-medium space-y-0.5">
                        ...
                        {{-- <li>
                            <a href="{{ route('users.show', $user->id) }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>
                                Mi Perfil
                            </a>
                        </li> --}}
                        {{-- Usuarios - solo admin --}}
                        ...
                        <li>
                            <a href="{{ route('info') }}"
                                class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded gap-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                                Info
                            </a>
                        </li>
                        {{-- Manual de usuario --}}
                        ...
                        <li class="border-t border-default-medium mt-1 pt-1">
                            <form action="{{ route('logout') }}" method="post">
                                ...
                                <button type="submit"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>
                                    Cerrar Sesión
                                </button>
                            </form>
                        </li>
        ...
        <ul class="space-y-1 font-medium mt-14" data-accordion="accordion">
            ...
            <li>
                <a href="{{ route('pacientes.index') }}"
                    class="sidebar-link flex items-center gap-3 px-2 py-1.5 text-body rounded-base hover:bg-blue-50 hover:text-blue-600 w-full {{ str_starts_with($rutaActual, 'pacientes') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    <span>Pacientes</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('jornadas.index') }}"
                    class="sidebar-link flex items-center gap-3 px-2 py-1.5 text-body rounded-base hover:bg-blue-50 hover:text-blue-600 w-full {{ str_starts_with($rutaActual, 'jornadas') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="M10 16h4"/><path d="M12 14v4"/></svg>
                    <span>Jornadas</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('tratamientos.index') }}"
                    class="sidebar-link flex items-center gap-3 px-2 py-1.5 text-body rounded-base hover:bg-blue-50 hover:text-blue-600 w-full {{ str_starts_with($rutaActual, 'tratamientos') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('modulo.reporte.index', $moduloJefe->id) }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M15 18H9"/><path d="M15 14H9"/><path d="M6 22h12a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2z"/></svg>
            ...
            <li>
                <button data-accordion-target="#modulos-content" aria-expanded="false"
                    ...
                    <svg class="w-4 h-4 shrink-0 transition-transform duration-200" fill="currentColor" viewBox="0 0 20 20">
                ...
                <ul class="py-1 space-y-0.5 pl-2">
                    ...
                    <li>
                        <a href="{{ route('jornadas.index') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="M10 16h4"/><path d="M12 14v4"/></svg>
                            Jornadas
                        </a>
                    </li>
                    <li>
