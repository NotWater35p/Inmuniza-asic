                    ...
                    <ul class="py-1 space-y-0.5 pl-2">
                        ...
                        <li>
                            <a href="{{ route('descargo.create') }}"
                                class="sidebar-link flex items-center gap-3 px-2 py-1.5 text-body rounded-base hover:bg-orange-50 hover:text-orange-600 w-full {{ str_starts_with($rutaActual, 'descargo') ? 'active' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
